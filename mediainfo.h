...
void *OpenMediaFile(char *filePath)
{
...
void CloseMediaFile(void *handle)
{
    MediaInfo_Close(handle);
    MediaInfo_Delete(handle);
}

const char *GetMediaInfo(void *handle, MediaInfo_stream_C streamKind, size_t StreamNumber, char *Parameter, MediaInfo_info_C KindOfInfo, MediaInfo_info_C KindOfSearch)
{
